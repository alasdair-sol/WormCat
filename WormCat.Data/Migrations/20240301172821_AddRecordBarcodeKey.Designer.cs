...
namespace WormCat.Razor.Migrations
{
    ...
    [Migration("20240301172821_AddRecordBarcodeKey")]
    partial class AddRecordBarcodeKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WormCat.Library.Models.Book", b =>
                {
                    ...
                    b.HasOne("WormCat.Library.Models.Record", null)
                        .WithMany("Books")
                        .HasForeignKey("RecordBarcode");
